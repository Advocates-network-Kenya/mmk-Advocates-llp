            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        <p>
                            <span class="text-primary">MK Advocates LLP</span> is a forward-thinking and dynamic law firm
                            based in Kenya,offering a comprehensive array of legal services to a diverse clientele.
                        </p>
                        <p>
                            Our clients include local and international corporations, government entities, multinational
                            companies, non-governmental organizations (NGOs), and high-net-worth individuals. The firm is
